...
A selected list based on my current research interests-[grouped by topic](https://ghadaalmashaqbeh.github.io/publications/), [sorted by date](https://ghadaalmashaqbeh.github.io/publications/by-date/). Check [here](https://scholar.google.com/citations?hl=en&user=QKIkII0AAAAJ&view_op=list_works&sortby=pubdate) for a complete publications list.<br/>
